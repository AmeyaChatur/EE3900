...
\\\solution
The following code computes and plots at each n. We can see that the sum converges to a constant value < \infty as n goes to \infty
\lstinputlisting{codes/5_6.py}
\includegraphics{figures/Figure_5_6_new.png}
\item 
