...
\item In the circuit, the switch S is connected to position P for a long time so that the charge on the capacitor
	becomes $q_1 \, \mu C$. Then S is switched to position Q.  After a long time, the charge on the capacitor is
		...
		\begin{figure}[!ht]
			\centering
			\includegraphics[width=\columnwidth]{figures/Figure_1_ckt.jpg}
			\caption{}
			\label{fig:ckt}
\end{figure}
\item Find $q_1$.
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{figures/Figure_2_ckt.png}
...
\begin{figure}[!htb]
    \includegraphics[width=\columnwidth]{figures/Figure_3_ckt.png}
